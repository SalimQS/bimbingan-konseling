...
if ($page === 'peraturan' && $action === 'download_template') {
  $templatePath = __DIR__ . '/storage/peraturan-upload-example.xlsx';
  if (!is_file($templatePath)) {
    http_response_code(404);
    echo 'File contoh format tidak tersedia.';
    exit;
  }

  header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
  header('Content-Disposition: attachment; filename="peraturan-upload-example.xlsx"');
