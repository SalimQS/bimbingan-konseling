...
<?php
  ...
  if(isset($_POST['changeFoto'])) {
    ...
    if(($_FILES['foto']['size'] >= $maxSize)) {
      ...
      $connect->begin_transaction();
      $query = "UPDATE guru SET foto='$file' WHERE id = '". $_GET['id'] ."'";
      $result = $connect->query($query);
      if($result) {
  ...
  $query = "SELECT * FROM guru WHERE id='" . $_GET['id'] . "'";
  $result = $connect->query($query);
        ...
        <form method="POST">
            <div class="row mt-2">
                ...
                <div class="col-md-12 mb-4">
                  ...
                  <input type="text" class="form-control" placeholder="Nomor Telepon" name="no_telepon" value="<?= $user['telepon'] ?>">
                </div>
            </div>
            <div class="row">
