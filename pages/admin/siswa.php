    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                ...
                <?php } ?>
                <?php      
                  $query = "SELECT users.id, users.username, biodata.nama_lengkap, biodata.foto, biodata.jenis_kelamin, biodata.status, siswa.semester, prodi.nama_prodi FROM users ";
                        ...
                        <table class="table table-bordered table-striped dataTable">
                            ...
                            if($result->num_rows > 0) {
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><?= $siswa[$i]['nama_prodi'] ?></td>
                                            ...
                                            <form method="post" class="col-12 col-md-8 formChangeStatus" nama-siswa="<?= $nama?>" status="<?= $siswa[$i]['status'] ?>">
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 col-md-6">
                                                        <a 
                                                            href="?page=siswa&action=edit&id=<?= $siswa[$i]['id'] ?>"
                                                            name='delete' 
                                ...
                                ?>                                
                                <tr>
                                    <td colspan="9" class='text-center'>Tidak ada matasiswa</td>
                                </tr>
                                <?php
                            }
                            ?>
