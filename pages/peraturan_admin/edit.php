...
<?php
  ...
  if(isset($_POST['simpan'])) {
    ...
    if($jenis == '') {
      ...
      try {
        $query = "UPDATE `peraturan` SET `jenis_peraturan`='$jenis',`poin_peraturan`='$sanksi' WHERE `id_peraturan`='" . $_GET['id'] . "'";//$_GET['id']
  ...
  $query = "SELECT * FROM `peraturan` WHERE `id_peraturan`='" . $_GET['id'] . "'";
  $result = $connect->query($query);
